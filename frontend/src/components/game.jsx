            ...
            scene: {
                ...
                update: function() {
                    if (this.container) {
                        ...
                        this.physics.add.collider(this.container, this.pokerTable, () => game.props.openModal("createLobby"))
                        this.physics.add.collider(this.container, this.blackjackTable, () => game.props.openModal("createLobby"));
                        this.physics.add.collider(this.container, this.slotsTable, () => game.props.openModal("createLobby"))
